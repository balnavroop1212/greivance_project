...
class _OverviewScreenState extends State<OverviewScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return DefaultTabController(
      length: 4, // Added In Progress to match history logic if needed, or 3 if sticking strictly to image
      child: Scaffold(
    ...
    if (filtered.isEmpty) {
      return Center(
        child: Column(
          ...
          children: [
            Icon(Icons.assignment_outlined, size: 80, color: Colors.grey.withValues(alpha: 0.2)),
            ...
            Expanded(
              child: SingleChildScrollView(
                ...
                child: Column(
                  ...
                  children: [
                    // 1. Header Card: Title and Status Chip with fix for overlap
                    Container(
                    ...
                    // 4. Attachment Section (Cloudinary Image)
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          Text(
            label, 
            style: TextStyle(fontSize: 13, fontWeight: FontWeight.w500, color: isDarkMode ? Colors.white38 : Colors.black38)
          ),
